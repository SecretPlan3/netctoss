...
public class BillTimeController {
	...
	public @ResponseBody PagerBean findAllBillTime(PagerBean pb) {
		//查询所有用户账号
		System.out.println("进入了findAllBillTime");
	...
	public ModelAndView BillTimeMonthly(Long id){
		System.out.println("进入了BillTimeMonthly");
		System.out.println("id" + id);
		ModelAndView mv = new ModelAndView();
		mv.addObject("userId", id);
		mv.setViewName("billtimeDetailMonthly");
		return mv;
	}
