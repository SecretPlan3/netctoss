...
<link rel="stylesheet" href="<%=basePath%>static/css/amazeui.min.css"/>
	...
	<!-- 本页面的js代码 -->
	<script type="text/javascript" src="<%=basePath%>jsp/bill/chart.js" charset="utf-8"></script>
	<title>图形报表</title>
 <!-- 4.页面规范的样式 -->
    <style>
        .header{
            ...
            <div class="modal-content">
                <div class="modal-header">
                	<div id="div0002" style="display:block">
	                	<div id="div0001" style="width:600px;height:50px;magin:0px auto">
                ...
                <div class="modal-body">
						...
						<div>
							...
							<select id="OSNameSel" class="OSNameSel"> <!-- data-am-selected="{btnWidth: 110, btnSize: 'sm', btnStyle: 'default'}" -->
								<!-- 动态数据 -->
								<option value="ttwww">ttwww</option>
								<option value="20eqqq16">20eqqq16</option>
								<option value="ggeeee">ggeeee</option>
							</select>
						</div>
