		...
		<div class="search">
			<ul class="am-nav am-nav-pills am-topbar-nav ">
				...
				<li class="soso">
					...
					<p class="ycfg">
						<input type="text" class="am-form-field am-input-sm" id="mtel"
							placeholder="手机" />
					</p>
					<p>
						...
						<form role="form" id="addform">
							<div class="form-group">
								<label>姓名</label> <input type="text" class="form-control "
									placeholder="姓名" name="magName">
							</div>
							<div class="form-group">
								<label>登录账号</label> <input type="text" class="form-control "
									placeholder="登录账号" name="loginName">
							</div>
							<div class="form-group">
				...
				<div class="modal-body">
					<div class="tc001_body_content">
						<form role="form" id="updateform">
							<div class="form-group">
								<input type="hidden" class="update0" name="id"> <label>姓名</label>
								<label class="form-control update1" name="magName"></label>
							</div>
							<div class="form-group">
								<label>登录账号</label> <label class="form-control update2"
									name="loginName"></label>
							</div>
							<div class="form-group">
								<label>登录密码</label> <label class="form-control update3"
									name="password"></label>
							</div>
							<div class="form-group">
								<label>手机号</label> <input type="text" class="form-control"
				...
				<div class="modal-body">
					<div class="tc001_body_content">
						<form role="form" id="findform">
							<div class="form-group">
								<input type="hidden" class="find0" name="id"> <label>姓名</label>
								<input type="text" class="form-control find1"
									disabled="disabled" name="magName">
							</div>
							<div class="form-group">
								<label>登录账号</label> <input type="text"
									class="form-control find2" disabled="disabled" name="loginName">
							</div>
							<div class="form-group">
								<label>登录密码</label> <input type="text"
									class="form-control find3" disabled="disabled" name="password">
							</div>
							<div class="form-group">
								<label>手机号</label> <input type="text" class="form-control find4"
									disabled="disabled" name="tel">
							</div>
							<div class="form-group">
								<label>邮箱</label> <input type="text" class="form-control find5"
