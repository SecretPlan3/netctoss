...
<body>
        <div class="page-container">
            <h1>中国电信</h1>
            <form action="<%=basePath %>managermag/login" id = "form0" name="user" method="post">
            ...
            <div class="connect">
                <a style="color: white;font-size: 14px;width: 100px" href="userlogin.jsp" target="_self" title="用户登录">用户登录</a>
                <p>
